...
var View = function () {
  function View(containerId, template) {
    var containerElement = document.getElementById(containerId); // getElementId는 HTMLElement | null을 반환하기 때문에 null인 경우를 따로 처리해줘야 에러가 사라집니다.
  ...
  function NewsFeedView(containerId, store) {
          ...
          switch (_d.label) {
            ...
            case 2:
              for (i = (this.store.currentPage - 1) * 10; i < this.store.currentPage * 10; i++) {
                ...
                this.addHtml("\n      <div class=\"" + (this.store.getFeed(i).read ? 'bg-red-500' : 'bg-white') + " mt-6 p-6 rounded-lg shadow-md duration-500 hover:bg-green-100\">\n        <div class=\"flex\">\n          <div class=\"flex-auto\">\n            <a href=\"#/show/" + id + "\">" + title + "</a>\n          </div>\n          <div class=\"text-center text-sm\">\n            <div class=\"w-10 text-white bg-green-300 rounded-lg px-0 py-2\">\n              " + comments_count + "\n            </div>\n          </div>\n        </div>\n        <div class=\"flex mt-3\">\n          <div class=\"grid grid-cols-3 text-sm text-gray-500\">\n            <div><i class=\"fas fa-user mr-1\"></i>" + user + "</div>\n            <div><i class=\"fas fa-heart mr-1\"></i>" + points + "</div>\n            <div><i class=\"fas fa-clock mr-1\"></i>" + time_ago + "</div>\n          </div>\n        </div>\n      </div>\n    ");
              }
    ...
    _this.renderView = function () {
      for (var i = (_this.store.currentPage - 1) * 10; i < _this.store.currentPage * 10; i++) {
        ...
        _this.addHtml("\n      <div class=\"" + (_this.store.getFeed(i).read ? 'bg-red-500' : 'bg-white') + " mt-6 p-6 rounded-lg shadow-md duration-500 hover:bg-green-100\">\n        <div class=\"flex\">\n          <div class=\"flex-auto\">\n            <a href=\"#/show/" + id + "\">" + title + "</a>\n          </div>\n          <div class=\"text-center text-sm\">\n            <div class=\"w-10 text-white bg-green-300 rounded-lg px-0 py-2\">\n              " + comments_count + "\n            </div>\n          </div>\n        </div>\n        <div class=\"flex mt-3\">\n          <div class=\"grid grid-cols-3 text-sm text-gray-500\">\n            <div><i class=\"fas fa-user mr-1\"></i>" + user + "</div>\n            <div><i class=\"fas fa-heart mr-1\"></i>" + points + "</div>\n            <div><i class=\"fas fa-clock mr-1\"></i>" + time_ago + "</div>\n          </div>\n        </div>\n      </div>\n    ");
      }
